...
UPLOAD_FOLDER = '/Users/nrajan625/Documents/Software/Project/static/photo'
...
def predict():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            img_path = '/Users/nrajan625/Documents/Software/Project/static/photo/{}'.format(filename)

    max_length = 32
    tokenizer = load(open("/Users/nrajan625/Documents/Software/Project/tokenizer.p","rb"))
    model = load_model('/Users/nrajan625/Documents/Software/Project/models/model_9.h5')
    ...
    tts.save('/Users/nrajan625/Documents/Software/Project/static/audio/{}.mp3'.format(audio_filename))
    Audio('/Users/nrajan625/Documents/Software/Project/static/audio/{}.mp3'.format(audio_filename), autoplay=True)
